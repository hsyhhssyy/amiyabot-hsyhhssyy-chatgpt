...
**3.0.10版是最后一个用消息驱动的版本，从下一个版本起，兔兔将不再通过消息驱动，但是表现行为应该没什么区别**

**3.0.10版精简了大量的参数，现在会根据群内消息密集程度动态控制自己的插话频率，保证自己平均每1分钟插一句话，不会出现连续频繁回复的情况，下个版本将会更加精简参数，减少配置复杂度**
